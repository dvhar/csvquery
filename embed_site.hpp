...
INCBIN(_main_3c1aae09_chunk_js_map,"../webgui/build/static/js/main.3c1aae09.chunk.js.map");
INCBIN(_main_3c1aae09_chunk_js,"../webgui/build/static/js/main.3c1aae09.chunk.js");
...
server.resource["^/static/js/main.3c1aae09.chunk.js.map$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view((const char*)g_main_3c1aae09_chunk_js_mapData, g_main_3c1aae09_chunk_js_mapSize)); };
server.resource["^/static/js/main.3c1aae09.chunk.js$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view((const char*)g_main_3c1aae09_chunk_jsData, g_main_3c1aae09_chunk_jsSize)); };
