...
INCBIN(_main_d83249ad_chunk_js,"../webgui/build/static/js/main.d83249ad.chunk.js");
...
INCBIN(_main_d83249ad_chunk_js_map,"../webgui/build/static/js/main.d83249ad.chunk.js.map");
...
server.resource["^/static/js/main.d83249ad.chunk.js$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view((const char*)g_main_d83249ad_chunk_jsData, g_main_d83249ad_chunk_jsSize)); };
...
server.resource["^/static/js/main.d83249ad.chunk.js.map$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view((const char*)g_main_d83249ad_chunk_js_mapData, g_main_d83249ad_chunk_js_mapSize)); };
