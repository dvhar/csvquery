...
IMPORT_BIN("../webgui/build/static/js/main.535df78e.chunk.js.map",_main_535df78e_chunk_js_map);
extern const char _main_535df78e_chunk_js_map[], _sizeof__main_535df78e_chunk_js_map[];
const size_t _main_535df78e_chunk_js_map_len = (size_t)_sizeof__main_535df78e_chunk_js_map;
...
IMPORT_BIN("../webgui/build/static/js/main.535df78e.chunk.js",_main_535df78e_chunk_js);
extern const char _main_535df78e_chunk_js[], _sizeof__main_535df78e_chunk_js[];
const size_t _main_535df78e_chunk_js_len = (size_t)_sizeof__main_535df78e_chunk_js;
...
server.resource["^/static/js/main.535df78e.chunk.js.map$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view(_main_535df78e_chunk_js_map, _main_535df78e_chunk_js_map_len)); };
...
server.resource["^/static/js/main.535df78e.chunk.js$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view(_main_535df78e_chunk_js, _main_535df78e_chunk_js_len)); };
