...
INCBIN(_main_0dd91176_chunk_js,"../webgui/build/static/js/main.0dd91176.chunk.js");
...
INCBIN(_main_0dd91176_chunk_js_map,"../webgui/build/static/js/main.0dd91176.chunk.js.map");
...
server.resource["^/static/js/main.0dd91176.chunk.js$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view((const char*)g_main_0dd91176_chunk_jsData, g_main_0dd91176_chunk_jsSize)); };
...
server.resource["^/static/js/main.0dd91176.chunk.js.map$"]["GET"] = [](shared_ptr<HttpServer::Response> response, shared_ptr<HttpServer::Request> request){ if (rejectNonLocals(request)) return; response->write(string_view((const char*)g_main_0dd91176_chunk_js_mapData, g_main_0dd91176_chunk_js_mapSize)); };
