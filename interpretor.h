...
enum varScopes { NO_FILTER, WHERE_FILTER=1, DISTINCT_FILTER=2, ORDER_FILTER=4, GROUP_FILTER=8, HAVING_FILTER=16, JOIN_FILTER=32, JSCAN_FILTER=64 };
enum varGen { V_ANY, V_INCLUDES, V_EQUALS, V_SCOPE1, V_SCOPE2, V_SCANSCOPE };
